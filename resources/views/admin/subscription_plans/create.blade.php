        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('subscription-plans.index') }}" class="btn btn-outline-dark">Back</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
        ...
        <form action="{{ route('subscription-plans.store') }}" method="POST" id="planForm">
            ...
            <div class="container-fluid">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="is_trial" id="is_trial" class="form-control">
                                        <option value="0" {{ old('is_trial') == '0' ? 'selected' : '' }}>No</option>
                                        <option value="1" {{ old('is_trial') == '1' ? 'selected' : '' }}>Yes</option>
                                    </select>
                                </div>
                ...
                <div class="pb-5 pt-3">
                    ...
                    <a href="{{ route('subscription-plans.index') }}" class="btn btn-outline-dark ml-3">Cancel</a>
                </div>
            </div>
        </form>
        <!-- /.card -->
