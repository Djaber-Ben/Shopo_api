        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-12 text-right">
                    <a href="{{ route('categories.create') }}" class="btn btn-primary">إنشاء فئة جديدة</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                        ...
                        <div class="card-tools">
                            <div class="input-group input-group" style="width: 450px;">
                                ...
                                <div class="card-titel" style="margin-left: 5px">
                                    <button class="btn btn-dark" type="button" onclick="window.location.href='{{ route('categories.index') }}'">إعادة التعيين</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(!empty($category->image))
                                                <div>
                                                    <img width="50" src="{{ asset('storage/'.$category->image) }}" alt="">
                                                </div>
                                            @endif
                                        </td>
                                        <td>
